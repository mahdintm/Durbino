<template>
  <div>
    <div v-show="!Lock_Phone || !Lock_Finger || !Lock_Camera" style="
        width: 100%;
        height: 100vh;
      ...
      <div class="alwaysOnDisplay">
        ...
        <div v-show="Lock_Finger" @click="Lock_Finger = !Lock_Finger" class="FingerPrint nav_select">
          <fa-icon icon="fingerprint" />
        </div>
        <div v-show="!Lock_Finger" @click="Lock_Finger = !Lock_Finger" class="FingerPrint nav_notselect">
          <fa-icon icon="fingerprint" />
        </div>
        <div class="bottomNav">
          <div v-show="Lock_Camera" @click="Lock_Camera = !Lock_Camera" class="nav_select">
            <fa-icon icon="camera" />
          </div>
          <div v-show="!Lock_Camera" @click="Lock_Camera = !Lock_Camera" class="nav_notselect">
            <fa-icon icon="camera" />
          </div>
          <div v-show="Lock_Phone" @click="Lock_Phone = !Lock_Phone" class="nav_select">
            <fa-icon icon="phone" />
          </div>
          <div v-show="!Lock_Phone" @click="Lock_Phone = !Lock_Phone" class="nav_notselect">
            <fa-icon icon="phone" />
          </div>
        </div>
      </div>
    ...
    <div style="
      ...
      ">
      <div>
        <video ref="video" autoplay class="camera" playsinline muted :srcObject="videoStream"></video>
      </div>
      <div class="btns">
        <b-button @click="Exit" class="btn__" style="margin-top: 2%">بستن اتاق</b-button>
      </div>
